...
const file_tenant_proto_rawDesc = "" +
	"\n" +
	"\ftenant.proto\x12\ttenant.v1\x1a\x1cgoogle/api/annotations.proto\"\xbf\x01\n" +
	"\x06Tenant\x12\x0e\n" +
	...
	"\rTenantService\x12g\n" +
	"\fCreateTenant\x12\x1e.tenant.v1.CreateTenantRequest\x1a\x1f.tenant.v1.CreateTenantResponse\"\x16\x82\xd3\xe4\x93\x02\x10:\x01*\"\v/v1/tenants\x12`\n" +
	"\tGetTenant\x12\x1b.tenant.v1.GetTenantRequest\x1a\x1c.tenant.v1.GetTenantResponse\"\x18\x82\xd3\xe4\x93\x02\x12\x12\x10/v1/tenants/{id}\x12l\n" +
	"\fUpdateTenant\x12\x1e.tenant.v1.UpdateTenantRequest\x1a\x1f.tenant.v1.UpdateTenantResponse\"\x1b\x82\xd3\xe4\x93\x02\x15:\x01*\x1a\x10/v1/tenants/{id}\x12i\n" +
	"\fDeleteTenant\x12\x1e.tenant.v1.DeleteTenantRequest\x1a\x1f.tenant.v1.DeleteTenantResponse\"\x18\x82\xd3\xe4\x93\x02\x12*\x10/v1/tenants/{id}B;Z9github.com/teresa-solution/api-gateway/proto/gen;tenantpbb\x06proto3"
